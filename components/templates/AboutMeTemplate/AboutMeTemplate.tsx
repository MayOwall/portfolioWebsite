...
const desc1Data =
    "안녕하세요. <br/> 사려깊음을 중시하는 프론트엔드 주니어 개발자, 이지은입니다. <br/><br/> 사용자, 개발자를 막론하고 클라이언트들에게 좋은 경험을 제공하는 것을 진심으로 즐기며, 이같은 경험을 만들기 위해 사려깊게 개발하고자 노력합니다. 일을 할 때 항상 일에 대한 그 목적과 이유에 대해 짚고 넘어가며, 이를 바탕으로 학습하고, 질문하며, 행동합니다. <br/><br/>그 외에도...";
